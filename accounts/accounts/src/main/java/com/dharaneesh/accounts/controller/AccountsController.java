...
@Tag(
        name = "CRUD REST API for Accounts in IOB",
        description = "CRUD REST API in IOB to CREATE,GET,UPDATE,DELETE accounts details"
)
@RestController
...
public class AccountsController {
    ...
    @Operation(
            ...
            description = "REST API to create new Customer & Accounts inside IOB"
    )
    @ApiResponses({
    ...
    @Operation(
            summary = "Fetch Accounts Detail REST API",
            description = "REST API to fetch Customer & Accounts details based on mobileNumber"
    )
    @ApiResponses({
    ...
    @Operation(
            summary = "Update Accounts Detail REST API",
            description = "REST API to update Customer & Accounts details based on a account number"
    )
    @ApiResponses({
            @ApiResponse(
                    responseCode = "200",
    ...
    @Operation(
            summary = "Delete Accounts Detail REST API",
            description = "REST API to delete Customer & Accounts details based on a account number"
    )
    @ApiResponses({
            @ApiResponse(
                    responseCode = "200",
